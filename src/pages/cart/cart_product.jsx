...
import { increaseItem,decreaseItem,removeCartItem } from "../../redux/action/action";
...
const AddedProduct = ({ list }) => {
  ...
  return (
    <div className="container product-conatiner d-flex flex-column w-sm-50 w-100">
      {list.map((element) => (
        <div className="card  my-3" style={{ Width: "200px" }} key={element.id}>
